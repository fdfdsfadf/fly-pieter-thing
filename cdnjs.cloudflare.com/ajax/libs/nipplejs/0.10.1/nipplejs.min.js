!function(t, i) {
    ...
    return e = [function(t, i, e) {
        ...
        function n(t) {
            f.has(t) && clearTimeout(f.get(t)),
            f.set(t, setTimeout(t, 100))
        }
        function s(t, i, e) {
            for (var o, n = i.split(/[ ,]+/g), s = 0; s < n.length; s += 1)
                o = n[s],
                t.addEventListener ? t.addEventListener(o, e, !1) : t.attachEvent && t.attachEvent(o, e)
        }
        function o(t, i, e) {
            for (var o, n = i.split(/[ ,]+/g), s = 0; s < n.length; s += 1)
                o = n[s],
                t.removeEventListener ? t.removeEventListener(o, e) : t.detachEvent && t.detachEvent(o, e)
        }
        function r(t) {
        ...
        function p(t, i) {
            i.top || i.right || i.bottom || i.left ? (t.style.top = i.top,
            t.style.right = i.right,
            t.style.bottom = i.bottom,
            t.style.left = i.left) : (t.style.left = i.x + "px",
            t.style.top = i.y + "px")
        }
        function a(t, i, e) {
            var o, n = c(t);
        ...
        var u, f = new Map, e = !!("ontouchstart"in window), y = !!window.PointerEvent, m = !!window.MSPointerEvent, g = {
            start: "mousedown",
            move: "mousemove",
            end: "mouseup"
        }, x = {};
        ...
        O.prototype.off = function(t, i) {
            ...
            void 0 === t ? this._handlers_ = {} : void 0 === i ? this._handlers_[t] = null : this._handlers_[t] && 0 <= this._handlers_[t].indexOf(i) && this._handlers_[t].splice(this._handlers_[t].indexOf(i), 1),
            this
        }
        ,
        O.prototype.trigger = function(t, i) {
            var e, o = this, n = t.split(/[ ,]+/g);
            o._handlers_ = o._handlers_ || {};
            for (var s = 0; s < n.length; s += 1)
                e = n[s],
                o._handlers_[e] && o._handlers_[e].length && o._handlers_[e].forEach(function(t) {
                    t.call(o, {
                        type: e,
                        target: o
                    }, i)
        ...
        O.prototype.config = function(t) {
            ...
            t && (this.options = function(t, i) {
                var e, o = {};
                for (e in t)
                    t.hasOwnProperty(e) && i.hasOwnProperty(e) ? o[e] = i[e] : t.hasOwnProperty(e) && (o[e] = t[e]);
                return o
            }(this.options, t))
        }
        ,
        ...
        w.prototype.stylize = function() {
            ...
            l(e.el, t),
            "circle" === this.options.shape && l(e.back, i),
            l(e.front, i),
            this.applyStyles(e),
            this
        }
        ...
        w.prototype.show = function(t) {
            var i = this;
            return i.options.dataOnly || (clearTimeout(i.removeTimeout),
        ...
        w.prototype.hide = function(i) {
            var t, e, o = this;
            return o.options.dataOnly || (o.ui.el.style.opacity = o.options.restOpacity,
            clearTimeout(o.removeTimeout),
            clearTimeout(o.showTimeout),
            clearTimeout(o.restTimeout),
            o.removeTimeout = setTimeout(function() {
                var t = "dynamic" === o.options.mode ? "none" : "block";
                o.ui.el.style.display = t,
                "function" == typeof i && i.call(o),
                o.trigger("hidden", o.instance)
            }, o.options.fadeTime),
            o.options.restJoystick && (t = o.options.restJoystick,
            (e = {}).x = !0 === t || !1 !== t.x ? 0 : o.instance.frontPosition.x,
            e.y = !0 === t || !1 !== t.y ? 0 : o.instance.frontPosition.y,
            o.setPosition(i, e))),
            o
        }
        ,
        ...
        w.prototype.computeDirection = function(t) {
            var i, e, o, n = t.angle.radian, s = Math.PI / 4, r = Math.PI / 2;
            if (s < n && n < 3 * s && !t.lockX ? i = "up" : -s < n && n <= s && !t.lockY ? i = "left" : 3 * -s < n && n <= -s && !t.lockX ? i = "down" : t.lockY || (i = "right"),
            t.lockY || (e = -r < n && n < r ? "left" : "right"),
            t.lockX || (o = 0 < n ? "up" : "down"),
            t.force > this.options.threshold) {
                var d, p = {};
                for (d in this.direction)
                    this.direction.hasOwnProperty(d) && (p[d] = this.direction[d]);
                var a = {};
                for (d in this.direction = {
                    x: e,
                    y: o,
                ...
                p)
                    p[d] === this.direction[d] && (a[d] = !0);
                if (a.x && a.y && a.angle)
                    return t;
                a.x && a.y || this.trigger("plain", t),
                a.x || this.trigger("plain:" + e, t),
                a.y || this.trigger("plain:" + o, t),
                a.angle || this.trigger("dir dir:" + i, t)
            } else
                this.resetDirection();
            return t
        }
        ...
        function T(t, i) {
            ...
            return t && "flex" === t.display && (this.parentIsFlex = !0),
            this.updateBox(),
            this.prepareNipples(),
            this.bindings(),
            this.begin(),
        ...
        T.prototype = new y,
        (T.constructor = T).id = 0,
        T.prototype.prepareNipples = function() {
            var o = this.nipples;
        ...
        T.prototype.begin = function() {
            var t = this.options;
            "static" === t.mode && ((t = this.createNipple(t.position, this.manager.getIdentifier())).add(),
            this.idles.push(t))
        }
        ,
        T.prototype.createNipple = function(t, i) {
            var e = this.manager.scroll
              ...
              , s = (t.x && t.y ? o = {
                x: t.x - s,
                y: t.y - r
            } : (t.top || t.right || t.bottom || t.left) && ((s = document.createElement("DIV")).style.display = "hidden",
            s.style.top = t.top,
            ...
            return n.dataOnly || (p(s.ui.el, o),
            p(s.ui.front, s.frontPosition)),
            this.nipples.push(s),
            this.trigger("added " + s.identifier + ":added", s),
            this.manager.trigger("added " + s.identifier + ":added", s),
            this.bindNipple(s),
            s
        }
        ,
        ...
        T.prototype.pressureFn = function(i, e, t) {
            ...
            o.pressureIntervals[t] = setInterval(function() {
                var t = i.force || i.pressure || i.webkitForce || 0;
                t !== n && (e.trigger("pressure", t),
                o.trigger("pressure " + e.identifier + ":pressure", t),
                n = t)
            }
            .bind(o), 100)
        }
        ...
        T.prototype.processOnStart = function(i) {
            function t(t) {
                t.trigger("start", t),
                e.trigger("start " + t.id + ":start", t),
                t.show(),
                0 < s && e.pressureFn(i, t, t.identifier),
                e.processOnMove(i)
            }
            var e = this
              , o = e.options
              ...
              , d = e.getOrCreate(n, r);
            d.identifier !== n && e.manager.removeIdentifier(d.identifier),
            d.identifier = n;
            if (0 <= (n = e.idles.indexOf(d)) && e.idles.splice(n, 1),
            e.actives.push(d),
            e.ids.push(d.identifier),
            "semi" !== o.mode)
                t(d);
            else {
                if (!(v(r, d.position) <= o.catchDistance))
                    return d.destroy(),
                    void e.processOnStart(i);
                t(d)
            }
            return d
        }
        ...
        T.prototype.getOrCreate = function(t, i) {
            ...
            return /(semi|static)/.test(o.mode) ? (e = this.idles[0]) ? (this.idles.splice(0, 1),
            e) : "semi" === o.mode ? this.createNipple(i, t) : (console.warn("Coudln't find the needed nipple."),
            !1) : this.createNipple(i, t)
        }
        ,
        T.prototype.processOnMove = function(t) {
            ...
            isNaN(s.buttons) ? 0 !== s.pressure : 0 !== s.buttons) {
                ...
                i.lockX && (e.y = o.position.y),
                i.lockY && (e.x = o.position.x);
                var r, d, p, a, c, l = v(e, o.position), h = (h = e,
                u = o.position,
                f = u.x - h.x,
                u = u.y - h.y,
                Math.atan2(u, f) * (180 / Math.PI)), u = b(h), f = l / s, y = {
                    distance: l,
                    position: e
                }, m = ("circle" === o.options.shape ? (r = Math.min(l, s),
                d = o.position,
                p = r,
                c = {
                    x: 0,
                ...
                a = b(h),
                c.x = d.x - p * Math.cos(a),
                c.y = d.y - p * Math.sin(a),
                d = c) : (p = e,
                a = o.position,
                c = s,
                d = {
                ...
                r = v(d, o.position)),
                i.follow ? s < l && (m = e.x - d.x,
                g = e.y - d.y,
                o.position.x += m,
                o.position.y += g,
                o.el.style.top = o.position.y - (this.box.top + n.y) + "px",
                o.el.style.left = o.position.x - (this.box.left + n.x) + "px",
                l = v(e, o.position)) : (e = d,
                l = r),
                e.x - o.position.x), g = e.y - o.position.y, n = (o.frontPosition = {
                    x: m,
                    y: g
                },
        ...
        T.prototype.processOnEnd = function(t) {
            ...
            0 <= i.ids.indexOf(o.identifier) && i.ids.splice(i.ids.indexOf(o.identifier), 1),
            0 <= i.actives.indexOf(o) && i.actives.splice(i.actives.indexOf(o), 1),
            /(semi|static)/.test(e.mode) ? i.idles.push(o) : 0 <= i.nipples.indexOf(o) && i.nipples.splice(i.nipples.indexOf(o), 1),
            i.manager.unbindDocument(),
            /(semi|static)/.test(e.mode) && (i.manager.ids[t.id] = t.identifier))
        }
        ,
        T.prototype.onDestroyed = function(t, i) {
            0 <= this.nipples.indexOf(i) && this.nipples.splice(this.nipples.indexOf(i), 1),
            0 <= this.actives.indexOf(i) && this.actives.splice(this.actives.indexOf(i), 1),
            0 <= this.idles.indexOf(i) && this.idles.splice(this.idles.indexOf(i), 1),
            0 <= this.ids.indexOf(i.identifier) && this.ids.splice(this.ids.indexOf(i.identifier), 1),
        ...
        P.prototype = new y,
        (P.constructor = P).prototype.prepareCollections = function() {
            var t = this;
        ...
        P.prototype.onAny = function(t, i) {
            var e, o = this, n = "processOn" + t.charAt(0).toUpperCase() + t.slice(1);
            i = r(i);
            return h(i, function(t) {
                e = o.getIdentifier(t),
                h(o.collections, function(t, i, e) {
                    0 <= e.ids.indexOf(i) && (e[n](t),
                    t._found_ = !0)
                }
                .bind(null, t, e)),
