...
!function(l, t, e, n, p) {
    try {
        ...
        p = function() {
            ...
            return t.unshift("Simple Analytics:"),
        ...
        var mt, gt = et(), vt = 0, yt = t.mode || J(z, "mode"), _t = !!(ee = t.collectDnt) === ee ? t.collectDnt : J(z, "ignore-dnt") == r || J(z, "skip-dnt") == r || J(z, "collect-dnt") == r, wt = !("false" == J(z, "auto-collect") || t.autoCollect === d), bt = t.saGlobal || J(z, "sa-global") || it + "_" + u, Et = L(t.ignorePages || J(z, "ignore-pages")), Ot = L(t.allowParams || J(z, "allow-params")), xt = L(t.nonUniqueHostnames || J(z, "non-unique-hostnames")), St = t.pathOverwriter || J(z, "path-overwriter"), Mt = t.metadataCollector || J(z, "metadata-collector");
        try {
        ...
        if (At.sri = d,
        D && (At.mobile = D.mobile,
        At.brands = S(D.brands)),
        ...
        var $t, jt, Dt = {}, Ct = (y.referrer || "").replace(v, ft).replace(/^https?:\/\/((m|l|w{2,3}([0-9]+)?)\.)?([^?#]+)(.*)$/, "$4").replace(/^([^/]+)$/, "$1") || h, Rt = 0, Ht = function(t, e) {
            var n;
            qt && (n = Z(dt, {
                type: "append",
        ...
        var Ut, It, Vt, Bt = function(t) {
            ...
            if (!function(t) {
                for (var e in Et) {
                    ...
                    if (n) {
                        var r = "/" == n[0] ? n : "/" + n;
                        if (r === t || new RegExp("^" + G(r).replace(/\\\*/gi, "(.*)") + "$","i").test(t))
                            return f
                    }
                }
                return d
            }(e))
                return "hash" == yt && s.hash && (e += s.hash.split("?")[0]),
                e;
            p(b + "ignoring " + e)
        }, Nt = function(t, e, n) {
            var r = Bt(e);
            if (r && $t != r) {
                $t = r,
                Dt.path = r,
                tt("v") && (Dt.viewport_width = Math.max(q.clientWidth || 0, l.innerWidth || 0) || null,
                Dt.viewport_height = Math.max(q[H] || 0, l.innerHeight || 0) || null),
                tt("l") && g[A] && (Dt[A] = g[A]),
                N && tt("sc") && (Dt.screen_width = N.width,
                Dt.screen_height = N.height);
                var a, i = l.performance, o = "navigation";
                try {
        ...
        }, zt = l.history, Ft = zt ? zt.pushState : h, Wt = l.dispatchEvent, Gt = "pushState";
        wt && Ft && Event && Wt && (zt.pushState = (te = zt[Xt = Gt],
        function() {
            var t, e = arguments, n = te.apply(this, e);
            return rt(Event) ? t = new Event(Xt) : (t = y.createEvent("Event")).initEvent(Xt, f, f),
            t.arguments = e,
            Wt(t),
            n
        }
        ...
        wt && "hash" == yt && "onhashchange"in l && M("hashchange", function() {
            Nt(1)
        }, d),
        wt ? Nt() : l.sa_pageview = function(t, e) {
            Nt(0, t, e)
        }
        ;
        var Jt = ["string", "number"]
          , Lt = function(t, e, n) {
            ...
            var r = rt(t)
              ...
              , i = typeof t;
            if (Jt.indexOf(i) < 0 && !r)
                return F(bt, u + " can't be " + i),
                a();
            try {
                if (r) {
                    var o = t();
                    if (Jt.indexOf(typeof o) < 0)
                        return F(bt, t + " returns no string: " + o),
                        a();
                    t = o
                }
            } catch (ne) {
        ...
        var Zt = l[bt]
          , Kt = Zt && Zt.q ? Zt.q : [];
        for (var Qt in l[bt] = Yt,
        Kt)
            W(Kt, Qt) && (Array.isArray(Kt[Qt]) ? Lt.apply(null, Kt[Qt]) : Lt(Kt[Qt]))
    } catch (re) {
        n(re)
    }
    var Xt, te, ee
